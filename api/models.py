...
class Bos(models.Model):
    ...
    activity = models.CharField(max_length=255, choices=(("Entreprenuership", "Entreprenuership"), (
        "Employability", "Employability"), ("Skill Development", "Skill Development")))
...
class Proposal(models.Model):
    ...
    funding_agency = models.CharField(max_length=255, choices=(
        ("government", "government"), ("non_government", "non_government")))
...
class Journal(models.Model):
    ...
    publication_type = models.CharField(max_length=255, choices=(
        ("international", "international"), ("national", "national")))
    listed_in = models.CharField(max_length=255, choices=(("scopus", "scopus"), (
        "web of science", "web of science"), ("googles scholar", "googles scholar")))
    document = models.FileField(blank=True, null=True)
...
class Grant(models.Model):
    ...
    government_type = models.CharField(max_length=255, choices=(
        ("government", "government"), ("non government", "non government")))
...
class CollabrativeActivity(models.Model):
    ...
    student_or_faculty = models.CharField(max_length=255, choices=(
...
class Activity(models.Model):
    ...
    program = type_of_activity = models.CharField(
        max_length=255, choices=(("UG", "UG"), ("PG", "PG")))
    type_of_activity = models.CharField(max_length=255, choices=(
        ("Exta-Curricular", "Extra-Curricular"), ("Co-Curricular", "Co-Curricular")))
...
class ConferenceAttendedByTeachers(models.Model):
    ...
    type = models.CharField(max_length=255, choices=(
        ("International", "International"), ("National", "National")))
    presented_papers_name = models.CharField(
...
class FacultyProfile(models.Model):
    ...
    designation = models.CharField(max_length=255, choices=(("Professor", "Professor"), ("Associate professor", "Associate professor"), (
        "Assistant professor", "Assistant professor"), ("Emeritus professor", "Emeritus professor"), ("others", "others")))
    date_of_birth = models.DateField()
    highest_qualification = models.CharField(
        max_length=255, choices=(("PG(M-tech)", "PG(M-tech)"), ("PhD", "PhD")))
    ...
    appointment_type = models.CharField(max_length=255, choices=(("Regular", "Regular"), (
        "Adhoc", "Adhoc"), ("contractual", "contractual"), ("Full-time visiting", "Full-time visiting")))
    ...
    job_status = models.CharField(max_length=255, choices=(
        ("active", "active"), ("leaving", "leaving")))
